...
{
    /// <inheritdoc />
    public partial class AssetUsage_Agreement_Nullable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgreemnentSignDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    AgreementUsageAgreement = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PersonAssetUsageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetsUsage", x => x.Id);
                });
        }
